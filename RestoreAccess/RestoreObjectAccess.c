/*
EnumProcessHanlde Work of Win10
*/
...
NTSTATUS RestoreObjectAccess(ULONG32 ActiveId, ULONG32 PassiveId)
{
	...
	for (Handle = 0;; Handle += HANDLE_VALUE_INC)
	{
		...
		*/
		...
		//wcscmp(*(PCWSTR*)((PUCHAR)ObjectType + 0x18), L"Process")

		if (ObjectType == *PsProcessType)
		{
			//EPROCESS + 0x2e8					+0x2e8 UniqueProcessId  : Ptr64 Void
			//*(PULONG32)((PUCHAR)Object + 0x2E8)
			if (PsGetProcessId(Object) == PassiveId)
			{
